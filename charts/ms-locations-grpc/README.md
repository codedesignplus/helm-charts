# ms-locations-grpc Helm Chart

This chart provides the configuration for deploying the ms-locations-grpc microservice in Kubernetes, based on the CodeDesignPlus SDK. It leverages the ms-base chart for best practices and common features such as deployment, service configuration, probes, autoscaling, Vault integration, Istio, and more.

## Structure

- **Chart.yaml**: Chart metadata.
- **values.yaml**: Default and configurable values for ms-locations-grpc.
...
```sh
helm upgrade --install ms-locations-grpc codedesignplus/ms-locations-grpc \
    --namespace <namespace> \
...
| `image.repository` | Container image | codedesignplus/ms-locations-grpc |
...
ms-base:
  ...
  image:
    repository: codedesignplus/ms-locations-grpc
    pullPolicy: IfNotPresent
    tag: "latest"

  imagePullSecrets: []
  fullnameOverride: "ms-locations-grpc"
  nameOverride: "ms-locations-grpc"
