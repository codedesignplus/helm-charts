# ms-users-grpc Helm Chart

This chart provides the configuration for deploying the ms-users-grpc microservice in Kubernetes, based on the CodeDesignPlus SDK. It leverages the ms-base chart for best practices and common features such as deployment, service configuration, probes, autoscaling, Vault integration, Istio, and more.

## Structure

- **Chart.yaml**: Chart metadata.
- **values.yaml**: Default and configurable values for ms-users-grpc.
...
```sh
helm upgrade --install ms-users-grpc codedesignplus/ms-users-grpc \
    --namespace <namespace> \
...
| `image.repository` | Container image | codedesignplus/ms-users-grpc |
...
ms-base:
  ...
  image:
    repository: codedesignplus/ms-users-grpc
    pullPolicy: IfNotPresent
    tag: "latest"

  imagePullSecrets: []
  fullnameOverride: "ms-users-grpc"
  nameOverride: "ms-users-grpc"
